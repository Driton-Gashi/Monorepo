      ...
      <div className="flex-grow">
        ...
        <div className="p-4">
          <ul className="space-y-1">
            <li>
              <Link href="dashboard/foods" className="flex items-center bg-red-200 rounded-xl font-bold text-sm text-yellow-900 py-3 px-4">
            ...
            <li>
              <Link href="" className="flex bg-white hover:bg-red-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
