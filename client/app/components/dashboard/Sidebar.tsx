    ...
    <div className="flex flex-col justify-between h-full">
      <div className="flex-grow">
        <div className="h-16 text-center border-b flex items-center justify-center">
          <h1 className="text-xl font-bold leading-none"><span className="text-primary-red">Food Order</span> App</h1>
        </div>
        <div className="p-4">
          <ul className="space-y-1">
          <li>
              <NavLink href="/dashboard" className={`flex items-center bg-white ${isDashboard ?'[&.active]:bg-primary-red [&.active]:text-primary-white':''} hover:bg-primary-red hover:text-primary-white   rounded-xl font-bold text-sm  py-3 px-4`}>
            ...
            <li>
              <NavLink href="/dashboard/food/all" className={`${isDashboardFood? 'active [&.active]:bg-primary-red ![&.active]:text-primary-white':''} flex items-center bg-white [&.active]:bg-primary-red hover:bg-primary-red hover:text-primary-white  rounded-xl font-bold text-sm [&.active]:text-primary-white py-3 px-4`}>
