    ...
    <div className="flex flex-col justify-between h-full">
      <div className="flex-grow">
        ...
        <div className="p-4">
          ...
          <li>
              <NavLink href="/dashboard" className="flex items-center bg-white [&.active]:bg-red-100 hover:bg-red-100  rounded-xl font-bold text-sm [&.active]:text-red-900 py-3 px-4">
            ...
            <li>
              <NavLink href="/dashboard/food" className="flex items-center bg-white [&.active]:bg-red-100 hover:bg-red-100  rounded-xl font-bold text-sm [&.active]:text-red-900 py-3 px-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
                  <path d="M4 .5a.5.5 0 0 0-1 0V1H2a2 2 0 0 0-2 2v1h16V3a2 2 0 0 0-2-2h-1V.5a.5.5 0 0 0-1 0V1H4V.5zM16 14V5H0v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2zm-3.5-7h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5z"/>
                </svg>Foods
              </NavLink>
